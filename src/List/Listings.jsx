...
function Listings({task}) {
  ...
  return (
    ...
    {/* <div>Listings</div> */}
    {task.map((valu)=>{
       return  <div className='idsf newtask'>
        <input id={`task-${valu}`} className='chkbx' type="checkbox" onChange={checuncheck}/>
        <label className='Tsk'>{valu}</label>
        <div className='status'> Focus</div>
        <button className='delt'>
